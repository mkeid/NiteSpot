...
- (id)initWithSessionCookie:(NSArray *)cookie  groupID:(NSString *)groupID{
    self = [super initWithNibName:@"GroupStatisticsViewController" bundle:nil];
    if (self) {
        // Custom initialization
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    NSString *requestURLString = [NSString stringWithFormat:@"%@/groups/%@/statistics.json", BaseURLString, _groupID];
